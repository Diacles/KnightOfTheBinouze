...
public class WinScreen implements Screen {
    ...
    public WinScreen(final KnightOfTheBinouze game) {
        this.game = game;
        camera = new OrthographicCamera();
        camera.setToOrtho(false, 800, 480);
        winner = Gdx.audio.newSound(Gdx.files.internal("Music/winner.mp3"));
        ...
        ImageButton gameOver = createButton("Screen/win.png", 700, 300);
